...
<div class="row-fluid">
        <div class="span12">
          <div class="box paint color_12">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Query Details</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('mycontroller/editdb_query');?>">
                ...
                <div class="form-row control-group row-fluid" style="display:none;">
                  <label class="control-label span3" for="normal-field">Time Stamp</label>
                  <div class="controls span9">
...
echo form_dropdown('company',$companies,set_value('company',$rowvalues->company));
                  ...
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="email" 
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    ...
                    value="<?php echo set_value('phone',$rowvalues->phone)?>">
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="normal-field">Query</label>
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="query" 
                    value="<?php echo set_value('query',$rowvalues->query)?>">
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
