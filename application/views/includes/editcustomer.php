...
<div class="row-fluid">
        <div class="span12">
          <div class="box paint color_12">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Edit Customer Details</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('site/editcustomersubmit');?>">
                ...
                <div class="form-row control-group row-fluid">
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" id="description-field" class="row-fluid" name="phone"  value="<?php echo $before->phone;?>">
                  </div>
                 </div>
                 <div class="form-row control-group row-fluid">
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="pointloyality" value="<?php echo $before->pointloyality ;?>">
                  </div>
                </div>
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="description-field">Date Of Birth</label>
                  <div class="controls span9">
                    <input type="text" id="datepicker1" class="row-fluid" name="dateofbirth" value="<?php echo $before->dateofbirth ;?>">
                  </div>
                 </div>
                  <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="description-field">Anniversary Date</label>
                  <div class="controls span9">
                    <input type="text" id="datepicker2" class="row-fluid" name="anniversary" value="<?php echo $before->anniversary ;?>">
                  </div>
                 </div>
