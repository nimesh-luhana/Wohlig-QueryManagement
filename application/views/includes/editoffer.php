...
<div class="row-fluid">
        <div class="span12">
          <div class="box paint color_12">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Offer Details</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('mycontroller/editdb_offer');?>">
...
echo form_dropdown('product',$products,set_value('product',$rowvalues->product));
                  ...
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="description" 
                    value="<?php echo set_value('description',$rowvalues->description)?>">
                  </div>
                </div>
                  ...
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="status"
                     value="<?php echo set_value('status',$rowvalues->status) ?>">
                  </div>
                </div>
