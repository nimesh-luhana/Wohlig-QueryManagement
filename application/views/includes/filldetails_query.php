       ...
       <div class="row-fluid">
        <div class="span12">
          <div class="box paint color_12">
            ...
            <div class="content">
              <form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('mycontroller/storeintodb_query');?>">
               ...
               <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="phone" value=<?php echo set_value('phone')?> >
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="normal-field">Query</label>
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="query" value=<?php echo set_value('query')?> >
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="normal-field">Json</label>
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="json" value=<?php echo set_value('json')?> >
                  </div>
                </div>
