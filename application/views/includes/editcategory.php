...
<div class="row-fluid">
        <div class="span12">
          <div class="box paint color_12">
            ...
            <div class="content">
              <form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('mycontroller/editdb_category');?>">
                ...
                <div class="form-row control-group row-fluid">
                 ...
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3">Parent</label>
                  <div class="controls span9">
				             <?php 
             
                      
                       echo form_dropdown('parent',$categories,set_value('contact_person',$rowvalues->parent));
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" id="normal-field" class="row-fluid" name="link" 
                    value="<?php echo set_value('contact_person',$rowvalues->link);?>">
                  </div>
                </div>
