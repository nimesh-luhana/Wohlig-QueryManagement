...
<div class="row-fluid">
        <div class="span12">
          <div class="box paint color_12">
            ...
            <div class="content">
              <form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('mycontroller/editdb_sales_area');?>">
             ...
             <div class="form-row control-group row-fluid">
               ...
               <div class="form-row control-group row-fluid">
				  ...
				  <?php 
                     ...
                     echo form_dropdown('area',$areas,set_value('areas',$rowvalues->area));
