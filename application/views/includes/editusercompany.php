...
<div class="row-fluid">
        <div class="span12">
          <div class="box paint color_12">
            ...
            <div class="content">
              <form class="form-horizontal row-fluid" method="post" action="<?php echo site_url('mycontroller/editdb_usercompany');?>">
                <div class="form-row control-group row-fluid" >
				  ...
				  <?php 
                     ...
                     echo form_dropdown('user',$users,set_value('user',$rowvalues->user));
